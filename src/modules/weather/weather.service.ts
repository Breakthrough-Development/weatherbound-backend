...
export class WeatherService {
  ...
  async getLocationAutocomplete(user: UserEntity, query: string) {
  ...
  async getDailyForecast(user: UserEntity, query: string) {
    const settings = await this.settingsService.findByUser(user);
  ...
  async getWeeklyForecast(user: UserEntity, query: string) {
    const settings = await this.settingsService.findByUser(user);
  ...
  async getCurrentWeather(user: UserEntity, query: string) {
    console.log(query);
    const settings = await this.settingsService.findByUser(user);
